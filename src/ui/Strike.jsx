...
import { BOMBER_RANGE, defenceOf, hexesApart } from '../game/bombing.js';
...
export function Strike({
  ...
  // What it would do, before the fighters and the flak take their cut.
  const hurt = men > 0 ? Math.min(WORST_STRIKE, (bombers * MEN_PER_BOMBER) / cover / men) : 0;
      ...
      <div className="march__head">
        ...
        <div className="march__buttons">
          ...
          <span className="march__count">
            {bombers
              ? `${formatUnits(bombers)} bombers · about ${formatUnits(Math.round(men * hurt))} men, at most`
